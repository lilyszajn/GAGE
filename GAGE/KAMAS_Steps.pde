...
/*SUDO CODE
Save all of the letter answers in ArrayList = answers
0. Date of test. Auto assign patient number.

IMAGES WITH QUESTIONS START

Step 1. Anything in mouth? Remove it. 
Step 2. Current condition of teeth. Dentures?  Dentures in right now? Use letter keys a/b/c
Step 3. Movements in mouth? Use letter keys y/n
Step 3a. Mouth interference? Rate on scale 0-4
Step 3b. Movements in face? y/n
Step 3c. interference? Rate on scale 0-4 (use keys)
Step 3d. Movements in hands? y/n
Step 3e. interference? Rate on scale 0-4 (use keys)
Step 3f. Movements in feet? y/n
3g. interference? Rate on scale 0-4 (use keys)

MOTION TRACKING STARTS

Step 4. VIDEO1 :: Sit, hands on knees, legs slightly apart, feet flat on floor. Measure overall motion for 10 seconds.
Step 5. VIDEO2 :: Sit, hands hanging unsupported either between legs or over knee. Measure overall motion for 10 seconds.
Step 6.  VIDEO3 :: Ask patients to tap fingers 10 seconds right hand. Measure legs. (hips, knees, ankles)
Step 6a.  VIDEO3a :: Ask patients to tap fingers 10 seconds left hand. Measure legs (hips, knees, ankles).
Step 7. VIDEO4 :: Ask patient to stand, staying still. Measure all joints, overall movement over 10 seconds.
Step 8. VIDEO5 :: Ask patient to walk 3 paces forward, turn, and walk back. Measure hands and angle of ankle to knee and knee to hip)
Step 8a. VIDEO5a :: Repeat step 8
Step 9. VIDEO6 :: Ask patient to extend both arms out in front, palms down (measure torso, hips, knees, ankle movement over 10 seconds)
//for all measurements lasting a period of time, show a countdown clock over a video image of the patient
//do not show dots or measurement tracking to patient

FACETRACKING STARTS

Step 9a. VIDEO6a :: Ask patient to extend both arms out in front, palms down (observe mouth)
Step 10. VIDEO7 :: Open mouth, keep tongue inside. Facetracking :: Measure tongue twitching for 10 seconds.
Step 10a. VIDEO7a :: Repeat 10
Step 11.  VIDEO8 :: Protrude tongue. Facetracking :: Measure tongue movement in and out of mouth for 10 seconds.
Step 11a. VIDEO8a :: Repeat 11
Step 12. VIDEO9 :: Ask patients to tap fingers 10-15 seconds right hand. Measure face.
Step 12a.  VIDEO9a :: Ask patients to tap fingers 10-15 seconds left hand. Measure face.


NOTES
1. Test cannot be completed in a dress
2. Chair must be firm and w/out arms. No reflective metal*/
...
//instructional videos from Dr. Dan Karlin
Movie step4intro; //VIDEO1
Movie step5intro; //VIDEO2
Movie step6intro; //VIDEO3
Movie step6Aintro; //VIDEO3a
Movie step7intro; //VIDEO4
Movie step8intro; //VIDEO5
Movie step8Aintro; //VIDEO5a
Movie step9intro; //VIDEO6
Movie step9Aintro; //VIDEO6a
Movie step10intro; //VIDEO7
Movie step10Aintro; //VIDEO7a
Movie step11intro; //VIDEO8
Movie step11Aintro; //VIDEO8a
Movie step12intro; //VIDEO9
Movie step12Aintro; //VIDEO9a
...
void drawStep6() {
  step4intro.play(); //play the movie once
  image(step4intro, 0, 0, width, height);
  played = true;
  background(255);
  fill(255);
  stroke(0);
...
void drawStep7() {
  ...
  if (millis() > 4000 && millis() < 53000) { //length of the intro
    image(step5intro, 0, 0, width, height);
  }
  else {
