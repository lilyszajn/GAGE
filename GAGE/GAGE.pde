/*This is code replicating the Abnormal Involuntary Motion Scale (AIMS) for the prognosis and diagnosis of the motion disorder Tardive Dyskinesia.
All rights reserved by GAGE LLC 2013
Code authors :: Lily Szajnberg && Greg Borenstein

--------------------------------------------------------------------------
*/

//Import all necessary libraries for P5
...
//declare all floats and objects
...
void setup() { 
  frameRate(30); //kinect framerate = 30 fps
  ...
  currentMovie = step6intro; //start with first video clip (curentMovie) and advance from there
  ...
  size(640, 480); //load the background image
